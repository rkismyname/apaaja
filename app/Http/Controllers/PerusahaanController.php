    ...
    public function store(Request $request)
{
    ...
    if ($request->hasFile('nib')) {
        ...
        $request->file('nib')->storeAs('public/file_nib', $nibFile);
    ...
    if ($request->hasFile('npwp_bu')) {
        ...
        $request->file('npwp_bu')->storeAs('public/file_npwp_bu', $npwpBuFile);
    ...
    if ($request->hasFile('akte_pend')) {
        ...
        $request->file('akte_pend')->storeAs('public/file_akte_pend', $aktePendFile);
    ...
    if ($request->hasFile('akte_peru')) {
        ...
        $request->file('akte_peru')->storeAs('public/file_akte_peru', $aktePeruFile);
    ...
    if ($request->hasFile('ktp')) {
        ...
        $request->file('ktp')->storeAs('public/file_ktp', $ktpFile);
    ...
    if ($request->hasFile('npwp_dir')) {
        ...
        $request->file('npwp_dir')->storeAs('public/file_npwp_dir', $npwpDirFile);
