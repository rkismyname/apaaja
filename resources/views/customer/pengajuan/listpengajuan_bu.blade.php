                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Telepon Perusahaan</th>
                            <th class="px-4 py-3">Email Perusahaan</th>
                            <th class="px-4 py-3">No Telepon Direktur</th>
                            <th class="px-4 py-3">Alamat Perusahaan</th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @foreach ($listPerusahaan as $perusahaan)
                            <tr class="text-gray-400 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">{{ $perusahaan->email_perusahaan }}</td>
                                <td class="px-4 py-3">{{ $perusahaan->tlp_pj }}</td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center">
                                        ...
                                        <form action="/perusahaan/list/{{ $perusahaan->perusahaan_id }}" method="POST"
                                            class="d-inline"
